...
THREE.CSJLoader = function ( manager ) {
	this.manager = ( manager !== undefined ) ? manager : THREE.DefaultLoadingManager;
};
THREE.CSJLoader.prototype = {
	constructor: THREE.CSJLoader,
	load: function ( url, onLoad, onProgress, onError ) {
		var scope = this;
		console.time( 'CSJLoader' );
		...
		loader.load( url, function ( text ) {
            ...
            console.timeEnd( 'CSJLoader' );
		}, onProgress, onError );
	},
	parse: function(text){
        var cntdetails = (text.model === undefined) ? text : text.model;
		var scope = this;
